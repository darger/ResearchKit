...
@interface ORKScaleQuestionResult : ORKQuestionResult {
	...
	NSNumber* _scaleAnswer;

}

@property (nonatomic,copy) NSNumber * scaleAnswer;              //@synthesize scaleAnswer=_scaleAnswer - In the implementation block
+(Class)answerClass;
-(id)_serializableDictionary;
-(NSNumber *)scaleAnswer;
-(void)setScaleAnswer:(NSNumber *)arg1 ;
