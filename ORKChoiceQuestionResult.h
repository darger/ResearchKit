...
@interface ORKChoiceQuestionResult : ORKQuestionResult {
	...
	NSArray* _choiceAnswers;

}

@property (nonatomic,copy) NSArray * choiceAnswers;              //@synthesize choiceAnswers=_choiceAnswers - In the implementation block
+(Class)answerClass;
-(id)_serializableDictionary;
-(NSArray *)choiceAnswers;
-(void)setChoiceAnswers:(NSArray *)arg1 ;
