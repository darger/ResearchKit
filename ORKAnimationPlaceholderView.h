...
@interface ORKAnimationPlaceholderView : UIView {
	...
	ORKEAGLMoviePlayerView* _playerView;

}

@property (nonatomic,retain) ORKEAGLMoviePlayerView * playerView;              //@synthesize playerView=_playerView - In the implementation block
-(void)setPlayerView:(ORKEAGLMoviePlayerView *)arg1 ;
-(ORKEAGLMoviePlayerView *)playerView;
