...
@interface ORKTimeIntervalQuestionResult : ORKQuestionResult {
	...
	NSNumber* _intervalAnswer;

}

@property (nonatomic,copy) NSNumber * intervalAnswer;              //@synthesize intervalAnswer=_intervalAnswer - In the implementation block
+(Class)answerClass;
-(id)_serializableDictionary;
-(NSNumber *)intervalAnswer;
-(void)setIntervalAnswer:(NSNumber *)arg1 ;
