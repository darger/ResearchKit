...
@class _ORKConsentSignatureWrapperView;

@interface ORKConsentSigningView : ORKVerticalContainerView {

	_ORKConsentSignatureWrapperView* _wrapperView;

}

@property (nonatomic,retain) _ORKConsentSignatureWrapperView * wrapperView;              //@synthesize wrapperView=_wrapperView - In the implementation block
-(void)setWrapperView:(_ORKConsentSignatureWrapperView *)arg1 ;
-(id)initWithFrame:(CGRect)arg1 ;
-(_ORKConsentSignatureWrapperView *)wrapperView;
@end
