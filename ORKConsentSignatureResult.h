...
@property (nonatomic,copy) ORKConsentSignature * signature;              //@synthesize signature=_signature - In the implementation block
-(void)applyToDocument:(id)arg1 ;
-(id)initWithCoder:(id)arg1 ;
-(void)encodeWithCoder:(id)arg1 ;
-(BOOL)isEqual:(id)arg1 ;
-(unsigned long long)hash;
-(id)copyWithZone:(NSZone*)arg1 ;
-(void)setSignature:(ORKConsentSignature *)arg1 ;
