...
@interface ORKCompletionStepView : ORKActiveStepCustomView {
	...
	double _animationPoint;

}

@property (assign,nonatomic) double animationPoint;              //@synthesize animationPoint=_animationPoint - In the implementation block
-(void)setAnimationPoint:(double)arg1 animated:(BOOL)arg2 ;
...
-(void)setAnimationPoint:(double)arg1 ;
