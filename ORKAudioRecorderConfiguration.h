...
@interface ORKAudioRecorderConfiguration : ORKRecorderConfiguration <ORKSerialization> {

	NSDictionary* _recorderSettings;

}

@property (nonatomic,readonly) NSDictionary * recorderSettings;              //@synthesize recorderSettings=_recorderSettings - In the implementation block
...
-(id)initWithRecorderSettings:(id)arg1 ;
