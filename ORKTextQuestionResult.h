...
@interface ORKTextQuestionResult : ORKQuestionResult {
	...
	NSString* _textAnswer;

}

@property (nonatomic,copy) NSString * textAnswer;              //@synthesize textAnswer=_textAnswer - In the implementation block
+(Class)answerClass;
-(id)_serializableDictionary;
-(NSString *)textAnswer;
-(void)setTextAnswer:(NSString *)arg1 ;
